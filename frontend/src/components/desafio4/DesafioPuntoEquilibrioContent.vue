...
const e4cIngresoPe = computed(() => e4cPe * 17.25)
...
<template>
  <div class="desafio-pe">
    ...
    <section class="desafio-pe__global desafio-pe__glass" aria-labelledby="pe-global">
      ...
      <h3 class="desafio-pe__h3-global">Fórmulas utilizadas</h3>
      ...
      <div class="desafio-pe__formula-row desafio-pe__formula-row--wrap">
        <span class="desafio-pe__formula-plain">Ingresos por ventas = Q × P</span>
      </div>
      <div class="desafio-pe__formula-row desafio-pe__formula-row--wrap">
        <span class="desafio-pe__formula-plain">Coste variable total CV = Q × CVU</span>
      </div>
      <div class="desafio-pe__formula-row desafio-pe__formula-row--wrap">
        <span class="desafio-pe__formula-plain">Coste total CT = CF + CV</span>
      </div>
    </section>
    ...
    <section class="desafio-pe__section" aria-label="Ejercicio 1">
      ...
      <div class="desafio-pe__card">
        ...
        <p class="desafio-pe__datos-title">Tabla de cálculo</p>
        <div class="desafio-pe__table-wrap desafio-pe__table-wrap--before-chart">
        ...
        <p class="desafio-pe__datos-title">Gráfico</p>
        <PeLineChart
          :fixed-cost="200_000"
          :unit-price="0.5"
    ...
    <section class="desafio-pe__section" aria-label="Ejercicio 2">
      ...
      <div class="desafio-pe__card">
        <p class="desafio-pe__datos-title">Consigna</p>
        <div class="desafio-pe__consigna">
          <p>Se tienen los siguientes datos respecto de una empresa:</p>
          <ul>
            <li>Costo fijo: $ 150.000</li>
            <li>Costo variable unitario: $ 500</li>
            <li>Precio unitario: $ 2.000</li>
          </ul>
          <p>Se pide:</p>
          <ul>
            <li>Calcular punto de equilibrio en unidades y en pesos.</li>
            <li>Graficar el punto de equilibrio.</li>
          </ul>
        </div>
        ...
        <div class="desafio-pe__result desafio-pe__result--sep">
          ...
          <p class="desafio-pe__result-note">
            Comprobación: PE<sub>$</sub> = PE<sub>u</sub> × P = 100 × 2.000 = $200.000.
          </p>
        </div>
    ...
    <section class="desafio-pe__section" aria-label="Ejercicio 3">
      ...
      <div class="desafio-pe__card">
        ...
        <div class="desafio-pe__result">
          <span class="desafio-pe__result-label">Margen de contribución</span>
          <div class="desafio-pe__formula-row">
            <span class="desafio-pe__formula-eq">MC =</span>
    ...
    <section class="desafio-pe__section desafio-pe__section--wide" aria-label="Ejercicio 4">
      ...
      <div class="desafio-pe__card">
        <p class="desafio-pe__datos-title">Consigna</p>
        <p class="desafio-pe__consigna">
          Precio base <strong>$15</strong>, CVU <strong>$8</strong>, CF <strong>$660</strong>. Tres situaciones de la
          consigna: situación base; incremento de costes fijos; aumento de precio y nuevos costes fijos.
        </p>
        ...
        <div class="desafio-pe__scenario-grid">
          <article class="desafio-pe__scenario">
            ...
            <p class="desafio-pe__datos-title desafio-pe__datos-title--inline">Gráfico</p>
            <PeLineChart
              :fixed-cost="660"
              :unit-price="15"
              :var-cost-per-unit="8"
        ...
        <div class="desafio-pe__ej4-conclusions desafio-pe__glass">
          ...
          <div class="desafio-pe__conclusion-block">
            ...
            <p>
              ...
              diferencia entre ambos PE es de unas <strong>14 bolsas</strong> (108,57 − 94,28).
            </p>
          </div>
