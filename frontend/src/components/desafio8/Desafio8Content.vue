<template>
  <div class="desafio-pe">
    <header class="desafio-pe__hero">
      <p class="desafio-pe__hero-kicker">Gestión gerencial · Desafío 8</p>
      <h1 class="desafio-pe__hero-title">Devlights — Análisis sociotécnico</h1>
      <p class="desafio-pe__hero-lead">
        Actividad grupal sobre <strong>Devlights</strong>: análisis de la empresa como sistema sociotécnico, sistema de
        información, FCE, problemáticas, gestión del cambio y propuestas desde el rol de futuro profesional ISI.
      </p>
    </header>

    <section class="desafio-pe__intro desafio-pe__glass" aria-labelledby="d8-problema">
      <h2 id="d8-problema" class="desafio-pe__h2">Problema abordado</h2>
      <p>
      ...
      <ol class="desafio-pe__gloss-list desafio-pe__gloss-list--indented desafio-pe__gloss-list--body">
        ...
        <li>Indicar problemáticas que afectan/podrían afectar a la empresa y ¿Cómo enfrentan el cambio?</li>
        <li>Realizar una propuesta, comentario y/o sugerencia sobre aportes desde su rol de futuro profesional.</li>
        <li>
    ...
    <section class="desafio-pe__section" aria-label="Solución propuesta">
      ...
      <div class="desafio-pe__card">
        ...
        <p>
          ...
          técnico (tecnologías, procesos, herramientas y conocimientos) y el social (personas, relaciones, cultura,
        ...
        <p>
          ...
          sino una solución organizativa y de gestión basada en la tecnología para enfrentar los retos del entorno. En
        ...
        <p>
          Desde la perspectiva de la Ingeniería en Sistemas de Información, y considerando los desafíos expuestos por la
        ...
        <p>
          Devlights se presenta como un modelo de negocio maduro y resiliente dentro del sector de la exportación de
          servicios informáticos en la región de Corrientes, con una trayectoria consolidada de una década en el mercado
          internacional. Fundada sobre bases de alta cohesión social surgidas del ámbito universitario, la organización
          ha sabido transicionar hacia un esquema operativo corporativo enfocado en resolver las necesidades de
          desarrollo de software para clientes de alta exigencia, localizados principalmente en los Estados Unidos.
        </p>
        <p>
          El valor diferencial de la empresa no se fundamenta en una estrategia de liderazgo en costos de mano de obra
          masiva, sino en un posicionamiento de nicho basado en la alta calidad técnica, la mantenibilidad de sus
          productos y ventajas geográficas estratégicas como el solapamiento horario (nearshoring). Estos factores,
          combinados con una sólida formación lingüística y cultural en inglés por parte de sus colaboradores, le
          permiten competir eficazmente contra polos de desarrollo consolidados en Asia y Europa del Este.
        </p>
        <p>
          Desde el punto de vista operativo, la empresa funciona como un sistema sociotécnico dinámico. En el plano
          técnico, abraza la transformación digital contemporánea adoptando una filosofía cloud-first e incorporando la
          Inteligencia Artificial no como un elemento disruptivo amenazante, sino como una herramienta de
          amplificación de la productividad de sus ingenieros. No obstante, esta velocidad tecnológica coexiste con
          desafíos organizacionales propios de la era del trabajo híbrido, tales como la necesidad de asegurar el
          compromiso ético de los desarrolladores frente al riesgo del multiempleo y la gestión del conocimiento técnico
          para mitigar el impacto de la rotación del talento humano.
        </p>
        <p>
          La estrategia de gestión de Devlights demuestra que en entornos de alta volatilidad tecnológica, la
          sostenibilidad de una empresa de software depende de su capacidad para equilibrar la flexibilidad técnica con
          el fortalecimiento de los canales humanos de aprendizaje, tales como la mentoría y la socialización orgánica en
          el espacio de trabajo. Frente a las brechas de innovación del mercado, la firma reafirma el rol fundamental
          del profesional de sistemas: aportar valor mediante el diseño no de soluciones genéricas, sino de la mejor
          alternativa técnica y económica para los objetivos de negocio de sus clientes.
        </p>
      </div>
    </section>

    <section class="desafio-pe__intro desafio-pe__glass" aria-labelledby="d8-herramientas">
      <h2 id="d8-herramientas" class="desafio-pe__h2">Herramientas utilizadas</h2>
      <div class="desafio-pe__chips desafio-pe__chips--d3">
        <span class="desafio-pe__chip">Teoría sociotécnica</span>
        <span class="desafio-pe__chip desafio-pe__chip--accent">Análisis de SI</span>
        <span class="desafio-pe__chip desafio-pe__chip--burgundy">Entrevista empresarial</span>
      </div>
    </section>

    <section class="desafio-pe__footer desafio-pe__glass" aria-labelledby="d8-reflexion">
      <h2 id="d8-reflexion" class="desafio-pe__h2">Reflexión del equipo</h2>
      <p>
        La visita a Devlights nos permitió contrastar la teoría de sistemas sociotécnicos con una empresa real del
        ecosistema local de software. Comprobamos que el éxito en outsourcing no depende solo de herramientas, sino de
        la alineación entre cultura, talento y procesos técnicos.
      </p>
      <p>
        Los FCE identificados —nearshoring, calidad, idioma y bench— explican por qué la firma compite globalmente
        desde Corrientes. A la vez, las problemáticas de IA, multiempleo y rotación muestran que la gestión del cambio
        y del conocimiento son tan críticas como la innovación tecnológica.
      </p>
      <p>
        Como futuros Ingenieros en Sistemas de Información, valoramos poder proponer soluciones concretas (CI/CD, wikis,
        gobernanza de IA) que conectan nuestra formación técnica con el impacto en el negocio del cliente.
      </p>
    </section>
  </div>
</template>
