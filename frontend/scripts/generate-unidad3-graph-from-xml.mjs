/**
 * Lee public/mapa/unidad3.xml (draw.io) y genera:
 *   src/mapaConceptual/nivel-operativo-unidad-3.graph.json (ELK en la app)
 *
 * Ejecutar desde frontend/: node scripts/generate-unidad3-graph-from-xml.mjs
 */
...
const xmlPath = path.join(root, 'public', 'mapa', 'unidad3.xml')
const outJsonPath = path.join(root, 'src', 'mapaConceptual', 'nivel-operativo-unidad-3.graph.json')
